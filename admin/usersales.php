...
<?php
  $user_id  = $_GET['user'];
  $sales_report_set = get_sales_byUser_today($user_id);
      ...
      <div class="page-wrapper">
                  ...
                  <div class="page-breadcrumb">
                      <div class="row align-items-center">
                          <div class="col-5">
                              <h4 class="page-title">Sales Report (<?php echo $user_id ?>)</h4>
                                      ...
                                      <div class="card">
                                        <div class="card-header">
                                          ...
                                          <div class="card-footer">
                                            <div class=""> <h4 class="float-left">Total Items Sold: <?php echo number_format($total_qty_sold) ?></h4> <h4 class="float-right">Total Amount:   <span class="font-medium">&#8358;<?php echo number_format($total_price) ?></span></h4></div>
                                          </div>
                                      </div>
                                  </div>
                              </div>
